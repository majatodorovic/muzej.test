...
const IzlozbaUGaleriji = async () => {
  ...
  return (
    <>
      <BreadcrumbsStatic
        breadcrumbs={[{ name: "Posetite nas" }, { name: "Izložba u galeriji" }]}
      />
      <section data-aos="fade-up" className="sectionPaddingB sectionPaddingX">
        <SingleExhibition post={allPosts[0]} />
      </section>
      <section
        data-aos="fade-up"
      ...
      >
        ...
        <ExhibitionPagination initialPosts={allPosts} totalPages={totalPages} />
      </section>
    </>
  );
};
...
export const metadata = {
  title: "Izložba u galeriji | Prirodnjački muzej",

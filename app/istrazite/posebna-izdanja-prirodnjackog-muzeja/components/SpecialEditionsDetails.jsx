...
const SpecialEditionsDetails = ({ data }) => {
  return (
    <div
      data-aos="fade-up"
    ...
    >
      <div className={`flex flex-col gap-8 text-black lg:w-1/2`}>
        {data?.name && (
          <h2
            className="fontForum titleH2 !text-left"
      ...
      <div className="mx-auto md:w-1/2">
        {data?.image && <SvgWithImage image={data.image} alt={data.name} />}
      </div>
    </div>
  );
};

export default SpecialEditionsDetails;
